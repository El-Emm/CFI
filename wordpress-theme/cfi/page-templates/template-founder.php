...
<main id="main">
	<header class="cfi-page-hero">
		<div class="cfi-container">
			...
			<h1><?php esc_html_e( 'Meet Evangelist Ebel Philips', 'cfi' ); ?></h1>
				...
				<div class="entry-content">
					...
					while ( have_posts() ) :
						...
						if ( get_the_content() ) {
							...
							<p><?php esc_html_e( 'Evangelist Ebel Philips answered a divine calling to serve those the world often overlooks — widows without support, children without school fees, families without food, and communities without hope. What began as grassroots compassion has grown into CharityFaith International, a US-registered nonprofit reaching nations across Africa and beyond.', 'cfi' ); ?></p>
							...
							<p><?php esc_html_e( 'Evangelist Ebel has led numerous crusades and community gatherings where the gospel is shared alongside practical aid. Her ministry bridges continents — mobilizing churches, partners, and donors to fuel transformation in vulnerable communities worldwide.', 'cfi' ); ?></p>
							<?php
						}
					endwhile;
					?>
	...
	<section class="cfi-section cfi-section--ivory">
		<div class="cfi-container cfi-text-center">
			...
			<p class="cfi-section__lead" style="margin:0 auto 2rem"><?php esc_html_e( 'Join Evangelist Ebel and the CFI family in bringing hope to the nations.', 'cfi' ); ?></p>
